        ...
        <div class="top_bar">
            ...
            <a href="" data-toggle="modal" data-target="#exampleModal">My Order Traking</a>                   
                ...
                @endphp
                                ...
                                @else
                                 <a href="{{ route('language.hindi') }}">Vietnamese<i class="fas fa-chevron-down"></i></a>
                                @endif        
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-3 col-3 order-1">
                        <div class="logo_container">
                            <div class="logo"><a href="{{ url('/') }}"><img src="{{ asset('public/frontend/images/logo6.png')}}" alt=""></a></div>
                        </div>
                    </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://www.facebook.com/itvlu/" target="_blank">ITVLU</a>
